...
def index():
    """a function return hello HBNB"""
    return "Hello HBNB!"


@app.route("/hbnb", strict_slashes=False)
def index_hbnb():
    """a function that will return HBNB"""
    return "HBNB"
...
def render_html(n):
    """function that enables renders html page with a variable"""
    return render_template("5-number.html", p=n)


@app.route('/number_odd_or_even/<int:n>', strict_slashes=False)
def render_html_variables(n):
    """function that is anble to renders html page with variables"""
    if n % 2 == 0:
        is_odd_or_even = "even"
    else:
        is_odd_or_even = "odd"
